...
It can store users, and use their APIKey as an authentication, store Feeds along with their posts, as well as a user defining which Feeds they want to follow and see their posts.
